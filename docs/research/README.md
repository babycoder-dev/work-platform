...
| spike | 服务的里程碑 | 任务包 | 报告 |
| --- | --- | --- | --- |
| OpenIM 部署裁剪评估 | M13 | `docs/tasks/vnext-spike-openim-deployment.md` | `openim-deployment-evaluation.md`（已产出） |
...
| Teable 解剖（DDL 层/公式/视图/协同） | M17-M18 | `docs/tasks/vnext-spike-teable-anatomy.md` | `teable-anatomy.md`（已产出） |
