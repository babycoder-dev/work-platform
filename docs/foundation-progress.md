...
| M8 人员 / 组织 / 档案       | 以人为中心的组织管理基座                                                                                | Pending | RFC 已 Accepted（拍板：近况记录归 `platform.status_logs`）；M8-1/M8-2a 任务包已二审定稿；依赖 M5/M6/M7       |
...
M8: 人员 / 组织 / 档案（RFC docs/rfc/m8-people-org-profile.md 已 Accepted，
  ...
  └ M8-1 部门管理任务包 docs/tasks/m8-1-department-management.md（已二审定稿，实现 PR 评审通过待合并；
